...
BASE_DIR = os.path.abspath(os.path.dirname(__file__))
APPS_DIR = r'C:\Users\Vedasamhitha Gopalam\Downloads\vedha\appv2 copy\apps'  # Your apps folder during dev
...
def send_email_notification(app_id):
    try:
        ...
        msg['From'] = 'vedasamhitha1978@gmail.com'      # Change as needed
        msg['To'] = 'veda@middlewaretalents.com'           # Change as needed

        with smtplib.SMTP('smtp.gmail.com') as server:
            server.login('vedasamhitha1978@gmail.com', 'xtas edoa xzxb gkbg')  # Use real SMTP creds
